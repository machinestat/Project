The Original Data Set and the Data Processing
...
3. Read the features.txt file and use it as column names for the tidy dataset.
4. Read the activity_labels.txt.
5. Read activicity label id file (train/y_train.txt and test/y_test.txt) then merge them together.
6. Read subject id file (train/subject_train.txt and test/subject_test.txt) then merge them together.
7. Read and merge the measurements file (train/X_train.txt and test/X_test.txt).
8. Export the data set.